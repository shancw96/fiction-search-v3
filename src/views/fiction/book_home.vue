<template>
    <article class=" border-box bgGrey" style="padding:  5px ">
        <CellContainer style="overflow:hidden">
            <van-row class="textCenter border-box "><div class="pd10 font20 bold">打穿西游的唐僧</div></van-row>
            <van-row class="row1" type="flex" justify="space-between">
                <van-col span="6">
                    <Img />
                </van-col>
                <van-col span="17" class="pd10" style="color: rgb(90, 89, 89);">
                    <van-row class="font18 marginTop5">会说话的肘子</van-row>
                    <van-row class="font18 marginTop5">来源：xxx</van-row>
                    <van-row class="marginTop10" type="flex" justify="flex-start">
                        <van-col v-for="index in 3" :key="index" span="4">
        ...
        <CellContainer class="marginTop15">
            <van-row><h3>标题</h3></van-row>
            <TextEllipsis class="grey" />
        </CellContainer>
    </article>
</template>
<script>
